...
wc = WordCloud(max_words=2000, max_font_size=30, mask=mask, random_state=41,background_color='white',colormap='autumn')
...
plt.axis('off')
plt.savefig('img/wordcloud_worst_characteristics.png', dpi=600, bbox_inches='tight')